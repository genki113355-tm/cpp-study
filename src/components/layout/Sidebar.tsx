...
import { CheckCircle2, Circle, X, ChevronDown, Trophy } from 'lucide-react';
import { ALL_CHAPTERS, CLASSIC_CHAPTERS, MODERN_CHAPTERS, READING_CHAPTERS, SPECIAL_GUIDES } from '../../data/chapters';
