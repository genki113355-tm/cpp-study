...
export const MilestoneModal: React.FC<MilestoneModalProps> = ({
  ...
  const milestones: Milestone[] = [
    ...
    },
    {
      ...
      shortTitle: 'コード読解修了証',
      icon: '🧭',
      trackName: `コード読解演習 (R1〜R${READING_CHAPTERS.length})`,
    ...
    },
    {
      ...
      icon: '👑',
      trackName: `全${ALL_CHAPTERS.length}章完全制覇`,
      ...
      description: `シロクマC++ラボの全カリキュラム（全${ALL_CHAPTERS.length}章）を走破し、現場のあらゆるC++開発に対応可能な卓越した技術を体得した最高栄誉です。`,
